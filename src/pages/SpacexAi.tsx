...
export const SpacexAi: FC = () => (
  ...
  >
    <Block heading="What's real today">
      <p>
        SpaceX and xAI, the company behind Grok, combined in 2026. That folded a frontier AI lab into
        the same entity that flies more orbital launches per year than the rest of the world combined,
        and it is one of the threads investors are buying into at the listing.
      </p>
      <p>
        The grounded version of "Space × AI" is already here: AI for autonomy and landing, models
        trained on vast launch and Earth-observation data, and an AI product line under the same roof
        as the launch and Starlink businesses.
      </p>
    </Block>

    <Block heading="What's still speculative">
      <p>
        The headline-grabbing version is a future scenario, not a shipped product: data centers in
        orbit, solar-powered compute above the atmosphere, an AI layer riding the satellite mesh. It
        is a useful way to imagine where cheap launch plus abundant power could lead, and we visualize
        it as exactly that: a possibility, not a roadmap.
      </p>
    </Block>
