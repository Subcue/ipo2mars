...
src/
  ...
  pages/             Hono JSX SSR pages (Home, SpacexIpo, Starlink, SpacexAi, Mars)
  ...
  client/            React + R3F island (built separately by esbuild)
    scene/           Earth, Starlink, Experience
...
- **Earth textures:** NASA-derived imagery (public domain), via the three.js examples.
